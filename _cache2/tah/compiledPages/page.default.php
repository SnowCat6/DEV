...
<? $parent = currentPage()?currentPageRoot():'production'?>
<h2 class="hot"><? module("doc:name:$parent"); ?></h2>
<div class="news menu"><? $module_data = array(); $module_data["parent"] = "$parent"; $module_data["type"] = "page"; moduleEx("doc:read:menuTree", $module_data); ?></div>
      </td>
    <td width="100%" height="100%" rowspan="3" valign="top" class="document"><h1><? module("page:title"); ?></h1>
      <? module("display"); ?></td>
