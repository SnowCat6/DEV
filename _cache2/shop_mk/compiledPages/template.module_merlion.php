...
UserID: <? if(isset($userID)) echo htmlspecialchars($userID) ?> <b><? if(isset($userName)) echo $userName ?></b><br />
UserIP: <? if(isset($userIP)) echo htmlspecialchars($userIP) ?><br />
Последняя запись: <? if(isset($lastWrite)) echo htmlspecialchars($lastWrite) ?>
</p>
<?
	}
