...
<input type="checkbox" name="banner[content][hide]" id="hideBanner"<?= $data['content']['hide']?' checked="checked"':''?> value="1" />
  ...
  <div><input type="text" name="banner[content][name]" class="input w100" value="<? if(isset($data["content"]["name"])) echo htmlspecialchars($data["content"]["name"]) ?>" /></div>
HTML код баннера
<div><textarea name="banner[content][html]" cols="" rows="8" class="input w100"><? if(isset($data["content"]["html"])) echo htmlspecialchars($data["content"]["html"]) ?></textarea></div>
</div>
...
Название формы
<div><input type="text" class="input w100" name="banner[feedback][name]" value="<? if(isset($data["feedback"]["name"])) echo htmlspecialchars($data["feedback"]["name"]) ?>"  /></div>
Название класса формы
<div><input type="text" class="input w100" name="banner[feedback][class]" value="<? if(isset($data["feedback"]["class"])) echo htmlspecialchars($data["feedback"]["class"]) ?>"  /></div>
</div>
