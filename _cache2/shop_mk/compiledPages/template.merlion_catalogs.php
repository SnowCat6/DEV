...
<input type="checkbox" name="merlionCatalog[<? if(isset($parentID)) echo htmlspecialchars($parentID) ?>]" value="<? if(isset($parentID)) echo htmlspecialchars($parentID) ?>" <? if(isset($class)) echo $class ?> />
<a href="<? if(isset($link)) echo $link ?>" id="ajax"><? if(isset($name)) echo htmlspecialchars($name) ?></a>
    ...
    <td><input name="merlionPrice[<? if(isset($parentID)) echo htmlspecialchars($parentID) ?>]" type="text" class="input" value="<? if(isset($price)) echo htmlspecialchars($price) ?>" size="60"  /></td>
    <td><? if ($data){ ?><input name="merlionDelete[<? if(isset($data)) echo htmlspecialchars($data) ?>]" type="checkbox" value="<? if(isset($data)) echo htmlspecialchars($data) ?>" /><? } ?></td>
</tr>
<? merlionCatalog($items, $parents, $avalible, $parentID, $deep + 1) ?><? } ?><? if (!$deep){ ?>
</table>
