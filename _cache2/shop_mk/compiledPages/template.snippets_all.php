...
?><? $module_data = array(); $module_data[] = "Все сниппеты"; moduleEx("page:title", $module_data); ?><? module("display:message"); ?>
<form action="<? module("getURL:snippets_all"); ?>" method="post" class="admin ajaxForm ajaxReload">
...
<tr>
    ...
    <td><? if(isset($code)) echo htmlspecialchars($code) ?></td>
</tr>
<? } ?><?
...
<tr>
    ...
    <td><input name="snippetsName[]" type="text" class="input w100" value="<? if(isset($name)) echo htmlspecialchars($name) ?>" /></td>
    <td><input name="snippetsValue[]" type="text" class="input w100" value="<? if(isset($code)) echo htmlspecialchars($code) ?>" /></td>
</tr>
<? } ?>
...
<p>Для показа сниппета в документах напишите <strong></strong> и при отображении на сайте, он заменится на код, указвнный вами. </p>
