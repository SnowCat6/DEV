...
<tr>
  ...
  <td><input type="text" name="settings[:loginza][URL]" class="input w100" value="<? if(isset($ini[":loginza"]["URL"])) echo htmlspecialchars($ini[":loginza"]["URL"]) ?>" /></td>
</tr>
<tr>
  <td nowrap="nowrap">Код подтверждения прав</td>
  <td><input type="text" name="settings[:SEO][loginza-verification]" class="input w100" value="<? if(isset($ini[":SEO"]["loginza-verification"])) echo htmlspecialchars($ini[":SEO"]["loginza-verification"]) ?>" /></td>
</tr>
<tr>
    <td nowrap="nowrap">Код сайта <strong>(ID)</strong></td>
    <td width="100%"><input type="text" name="settings[:loginza][id]" class="input w100" value="<? if(isset($ini[":loginza"]["id"])) echo htmlspecialchars($ini[":loginza"]["id"]) ?>" /></td>
</tr>
<tr>
  <td nowrap="nowrap">Секретный ключ</td>
  <td><input type="text" name="settings[:loginza][key]" class="input w100" value="<? if(isset($ini[":loginza"]["key"])) echo htmlspecialchars($ini[":loginza"]["key"]) ?>" /></td>
</tr>
</table>
