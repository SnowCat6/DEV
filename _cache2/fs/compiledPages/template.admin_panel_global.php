...
<input type="checkbox" name="globalSettings[:][useCache]" id="globalSiteUseCache" value="1"<?= @$gini[':']['useCache']?' checked="checked"':'' ?> />
    ...
    <td nowrap="nowrap"><input type="text" name="globalSettings[:][globalRootURL]" class="input w100" value="<? if(isset($globalRootURL)) echo htmlspecialchars($globalRootURL) ?>" /></td>
    <td width="100%" rowspan="4" align="right" valign="top">
<p><a href="<? module("url:admin_cacheLog"); ?>" id="ajax">Объекты кеша</a></p>
    </td>
  </tr>
  <tr>
    <td nowrap="nowrap">
...
<input type="checkbox" name="globalSettings[:memcache][server]" id="globalSiteUseMemcache" value="127.0.0.1"<?= $gini[':memcache']['server']?' checked="checked"':'' ?> />
  ...
  <tr>
    ...
    <td nowrap="nowrap"><input type="text" name="globalSettings[:][globalAccessIP]" class="input w100" value="<? if(isset($globalAccessIP)) echo htmlspecialchars($globalAccessIP) ?>" /></td>
    </tr>
  <tr>
    <td nowrap="nowrap">&nbsp;</td>
    <td nowrap="nowrap">&nbsp;</td>
