...
?><? //	Template module_advRoller loaded from  _packages/_advRoller/template.module_advRoller.php3 ?>
...
?>
<? module("page:style", 'advRoller.css') ?>
<div class="advRoller">
<?
$class = NULL;
foreach($advTable as $ix => &$adv){
	$class = is_null($class)?'':' style="display:none"';
?><div id="adv<? if(isset($ix)) echo htmlspecialchars($ix) ?>"<? if(isset($class)) echo $class ?> class="content"><? module("read:$adv"); ?></div><? } ?>
<? if (count($advTable) > 1){ ?>
<div class="seek">
<?
$class = NULL; $num = 0;
...
?><a href="#" id="adv<? if(isset($ix)) echo htmlspecialchars($ix) ?>"<? if(isset($class)) echo $class ?><? if(isset($rel)) echo $rel ?>><? if(isset($num)) echo htmlspecialchars($num) ?></a><? } ?>
</div>
<? } ?>
</div>
...
<? } ?><? //	Template doc_read_article_master loaded from  _sites/fs/_modules/_master/_read/template.doc_read_article_master.php3 ?>
...
<? function doc_read_master_before($db, $val, &$search){
	if (!isset($search[':order'])) $search[':order'] = 'masterDate ASC';
}
...
<? beginAdmin() ?>
        <div class="info bg">
<b>Ближайший мастер-класс:</b>
<address><a href="<? if(isset($link)) echo $link ?>"><? if(isset($data["fields"]["any"]["place"])) echo htmlspecialchars($data["fields"]["any"]["place"]) ?></a></address>
        </div>
        <div class="info2 bg2">
<a href="<? if(isset($link)) echo $link ?>"><?= masterDate($data)?></a>
...
<? } ?>
<? /*****************************************/
function masterSlot($db){
	$data	= $db->data;
	$id		= $db->id();
	$link	= getURL($db->url());
?>
<a href="<? if(isset($link)) echo $link ?>" class="image">
<?  if (beginCompile($data, "slot3")){ ?>
<? displayThumbImageMask(docTitleImage($id), 'design/m3.png')?>
<?  endCompile($data, "slot3"); } ?>
</a>
<? masterInfo($db)?>
<? } ?>
<? /********************************************/
...
<div class="holder"><? masterInfo($db)?></div>
</div>
<? } ?>
<? /*******************************************/
...
<div class="slot big">
<a href="<? if(isset($link)) echo $link ?>" class="image">
<?  if (beginCompile($data, "slot2")){ ?>
<? displayThumbImageMask(docTitleImage($id), 'design/m2.png')?>
<?  endCompile($data, "slot2"); } ?>
</a>
<div class="holder"><? masterInfo($db)?></div>
</div></td>
    <td valign="top" class="right" style="padding-left:10px"><div class="slot">
<?
	$db->next();
	masterSlot($db);
?>
...
<div class="slot"><? $db->next(); masterSlot($db);?></div>
    </td>
...
?>
    ...
    <a href="<? if(isset($link)) echo $link ?>">
<?  if (beginCompile($data, "slot4")){ ?>
	<? displayThumbImageMask(docTitleImage($id), 'design/m4.png')?>
<?  endCompile($data, "slot4"); } ?>
    </a>
    <div class="holder">
<? beginAdmin() ?>
        <div class="info bg">
            <a href=""><?= masterDate($data)?></a>
            <address><a href="<? if(isset($link)) echo $link ?>"><? if(isset($data["fields"]["any"]["place"])) echo htmlspecialchars($data["fields"]["any"]["place"]) ?></a></address>
        </div>
        <div class="info2 bg2">
            <h2><a href="<? if(isset($link)) echo $link ?>"><? if(isset($data["title"])) echo htmlspecialchars($data["title"]) ?></a></h2>
