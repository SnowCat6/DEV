...
<? $module_data = array(); $module_data[] = "Регистрация на сайте"; moduleEx("page:title", $module_data); ?>
<? ob_start() ?>
<? module("user:registerForm"); ?>
<? module("page:display:registerForm", ob_get_clean()) ?>
