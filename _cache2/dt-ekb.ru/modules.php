...
?>
<? // Module module_promo_access loaded from  _sites/dt-ekb.ru/_modules/_promo/module_promo_access.php ?>
﻿<?
function module_promo_access(&$access, &$ev)
{
	...
	return $data['fields']['any']['managerID'] == $userID;
}
?>
