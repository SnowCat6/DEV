...
<? }else echo $p; ?><? } ?><? if (!$search) endCache($cache); ?><? } ?>
...
<? return $search; } ?>
<? //	Template doc_page_page_master loaded from  _sites/fs/_modules/_master/_page/template.doc_page_page_master.php3 ?>
...
<? return $search; } ?>
<? //	Template doc_read_master3 loaded from  _sites/fs/_modules/_master/_read/template.doc_read_master3.php3 ?>
﻿<?
