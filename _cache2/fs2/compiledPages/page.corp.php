...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
    <td width="250" style="min-width:250px; padding-right:50px" valign="top">
<div class="menu menu2"><? $module_data = array(); $module_data["prop"]["!place"] = "master2"; moduleEx("doc:read:menu2", $module_data); ?></div>
    </td>
