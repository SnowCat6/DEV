...
?>
<form action="<? module("url:bask"); ?>" method="post" class="ajaxForm ajaxReload">
<? module("display:message"); ?><? module("bask:full"); ?><? module("page:style", 'feedback/feedback.css') ?>
<div class="<? if(isset($class)) echo htmlspecialchars($class) ?>">
<? if (module('bask')){ ?><? module("read:orderBefore"); ?>
...
?><? switch($type){ ?><? default:	//	text field?>
<tr>
