...
/***********************************/
.head {
	background:url(design/head2.png) no-repeat 114px 0;
}
.head .menu a {
}
/*********************************/
  ...
  <div class="body2">
    <div class="body3">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="head">
        <tr>
          <td width="114"><a href="<? module("url"); ?>"><img src="/design/logo2.gif" width="114" height="91" /></a></td>
          <td class="logo">
<h1>ТЕХИНСЕРВИС</h1>
<h2>инженерные системы и сети</h2>
            </td>
          <td width="100%">&nbsp;</td>
          <td class="headBask"><? module("bask:compact"); ?></td>
          <td class="headUser"><? module("user:compact"); ?></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="top">
        <tr>
          <td class="menu inline"><? $module_data = array(); $module_data["prop"]["!place"] = "menu"; moduleEx("doc:read:menu", $module_data); ?></td>
          <td class="right"><form id="form1" name="form1" method="post" action="<? module("getURL:search"); ?>" class="padding">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" class="page">
        <tr>
          <td valign="top" class="left">
            <div class="catalog menu"><? $module_data = array(); $module_data["type"] = "catalog"; $module_data["prop"]["!place"] = "map"; moduleEx("doc:read:menu3", $module_data); ?></div>
            <br clear="all" />
            <div class="hotSale">
              <h2>Хиты продаж</h2>
              <? $module_data = array(); $module_data["prop"]["!place"] = "sales"; moduleEx("doc:read:scroll", $module_data); ?></div>
            </td>
          <td valign="top" class="right"><h2>Новости:</h2>
            <div class="news"><? $module_data = array(); $module_data["type"] = "article"; $module_data["parent"] = "news"; moduleEx("doc:read:news", $module_data); ?></div></td>
        </tr>
      </table>
      </div>
  </div>
