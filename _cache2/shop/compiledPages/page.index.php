...
<img src="design/spacer.gif" width="200" height="1" />
    ...
    <? $module_data = array(); $module_data["prop"]["!place"] = "indexHot"; moduleEx("doc:read:scroll", $module_data); ?>
    <? module("doc:page:index"); ?>
    <? $module_data = array(); $module_data["prop"]["!place"] = "indexHotBottom"; moduleEx("doc:read:scroll", $module_data); ?>
	</td>
  </tr>
</table>
