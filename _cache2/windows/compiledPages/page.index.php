...
<? module("advFeedback:order"); ?>

<center class="indexAdvWindows menu">
	<ul class="inline">
        <li class="w1"><a href=""><div></div>ПЛАСТИКОВЫЕ ОКНА</a></li>
        <li class="w2"><a href=""><div></div>ДЕРЕВЯННЫЕ ОКНА</a></li>
        <li class="w3"><a href=""><div></div>СЕЗОН КОТТЕДЖЕЙ</a></li>
        <li class="w4"><a href=""><div></div>БАЛКОНЫ И ЛОДЖИИ</a></li>
        <li class="w5"><a href=""><div></div>НАТЯЖНЫЕ ПОТОЛКИ</a></li>
    </ul>
</center>
<? module("display"); ?>
	  </td>
