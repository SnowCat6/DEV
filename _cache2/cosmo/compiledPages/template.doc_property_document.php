...
<tr>
  ...
  <td style="padding-left:10px"><input name="doc[price]" type="text" class="input" value="<? if(isset($price)) echo htmlspecialchars($price) ?>" size="15" /></td>
  <td style="padding-left:10px"><input name="doc[price_old]" type="text" class="input" value="<? if(isset($price_old)) echo htmlspecialchars($price_old) ?>" size="15" /></td>
</tr>
</table>
<? }else{ ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<div><input name="doc[title]" type="text" value="<? if(isset($data["title"])) echo htmlspecialchars($data["title"]) ?>" class="input w100" /></div>
<? } ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
