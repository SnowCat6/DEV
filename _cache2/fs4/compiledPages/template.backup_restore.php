...
?><? $module_data = array(); $module_data[] = "Восстановление резервной копии"; moduleEx("page:title", $module_data); ?><? if (!$bHasBackup){
...
<? module("display:message"); ?><? if ($bRestoreSuccess) return; ?>
