...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="{$data[class]}">
        <tbody>
        <tr>
            <td valign="top" class="siteLogo" style="width:{$logoWidth}px; padding-right:{$data[logoPadding]}px"><module:file:image 
                	size		= "$data[logoSize]"
...
?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="{$data[class]}">
        <tbody>
        <tr>
            <td valign="top" style="padding-right:{$data[logoPadding]}px"><div class="siteBottomLogo">
                <module:file:image 
                        size		= "$data[logoSize]"
                        uploadFolder= "$data[imageFolder]/Title"
                        property.href="$url"
            ...
            <td valign="top" class="siteBottomInfo" width="100%"><module:read += ":$data[folder]/info" /></td>
          </tr>
      </tbody>
      </table>
  </div>
