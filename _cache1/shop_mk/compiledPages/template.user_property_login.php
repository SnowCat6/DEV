...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    ...
    <td width="100%"><input type="text" name="userLogin[login]" value="<? if(isset($data["login"])) echo htmlspecialchars($data["login"]) ?>" class="input w100" /></td>
  </tr>
  <tr>
    <td nowrap="nowrap">Пароль</td>
    <td><input type="text" name="userLogin[passw]" value="<? if(isset($data["passw"])) echo htmlspecialchars($data["passw"]) ?>" class="input w100" /></td>
  </tr>
<? if ($id){ ?>
  <tr>
    <td>&nbsp;</td>
