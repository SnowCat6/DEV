...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
    <td width="100%" valign="top"><? module("display"); ?></td>
    <td valign="top" class="saleSmall paddingRight" width="250" style="min-width:250px; padding-top:20px"><? module("doc:viewHistory:saleSmall:Вы смотрели"); ?></td>
</tr>
</table>
