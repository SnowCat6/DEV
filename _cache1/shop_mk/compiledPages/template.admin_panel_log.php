...
?>
Время выполнения: <b><? if(isset($eceuteTime)) echo htmlspecialchars($eceuteTime) ?></b> сек. <? if(isset($memUse)) echo $memUse ?>
