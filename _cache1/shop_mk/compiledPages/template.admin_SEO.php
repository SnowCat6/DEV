...
?>
<? $module_data = array(); $module_data[] = "Настройки SEO"; moduleEx("page:title", $module_data); ?>
<form action="<? module("getURL:admin_SEO"); ?>" method="post" class="admin ajaxForm">
...
<div><input name="SEO[titleEmpty]" type="text" value="<? if(isset($SEO["titleEmpty"])) echo htmlspecialchars($SEO["titleEmpty"]) ?>" class="input w100" /></div>
...
<div id="seoROBOTS" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
    <textarea name="valueROBOTS" cols="" rows="20" class="input w100"><? if(isset($robots)) echo $robots ?></textarea>
</div>

<div id="seoSITEMAP" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
    <textarea name="valueSITEMAP" cols="" rows="20" class="input w100"><? if(isset($sitemap)) echo $sitemap ?></textarea>
</div>
</form>
<script>
$(function() {
