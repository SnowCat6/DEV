<?
class systemHtaccess
{
/////////////////////////////////////////////
//	Создать .htaccess файл из настроек системы
	static function htaccessMake()
	{
		...
		foreach($sites as $rule => $host){
			self::htaccessMakeHost($rule, $host, $sitesRules, $ctx);
		}
	...
	static function htaccessMakeHost($hostRule, $hostName, &$ctx, &$htaccess)
	{
