...
// Только замена ссылок
  ...
  define('DUR_BASE_ROOT', 'http://xn----8sbknewdlutl.xn--p1ai/');               //Прописать принудительно <base href="http://domain.com/"> Бывает полезно при ссылках вида href="?page=2". При указании строки, пропишет ее
